...
RSpec.describe BusinessesController, type: :routing do
  describe 'routing' do
    ...
    #   expect(:get => '/businesses/1/edit').to route_to(
    #     'businesses#edit',
    #     id: '1'
    #   )
    # end
    ...
    #   expect(:put => '/businesses/1').to route_to(
    #     'businesses#update',
    #     id: '1'
    #   )
    # end
    ...
    #   expect(:patch => '/businesses/1').to route_to(
    #     'businesses#update',
    #     :id => '1'
    #   )
    # end
    ...
    #   expect(:delete => '/businesses/1').to route_to(
    #     'businesses#destroy',
    #     :id => '1'
    #   )
    # end
